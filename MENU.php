...
<body>
    ...
    <div class="tela">
      ...
      <div class="subtela1">
        ...
        <div class="titulo2">
          ...
          <a href="LOGIN-PRINCIPAL.php" class="botoes">Login</a>
          
          <a href="" class="botoes">Menu</a>

          <!-- deixar junto com a setinha -->
          <a href="" class="botoes">Config</a>
          <a href="" class="botoes">Sobre</a>
      ...
      <div class="subtela2">
        <!-- Lista de Lembretes -->
        <div class="menu1">
          <a href="PALARME-CRIAR.php" class="botoes">Criar</a>
          <div class="caixa">
  ...
  <div id="popup-container">
    ...
    <button id="popup-edit-btn" aria-label="Editar">Editar</button>
